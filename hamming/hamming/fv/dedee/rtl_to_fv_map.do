...
# Generated on: Sat Nov 01 14:48:37 IST 2025 (Sat Nov 01 09:18:37 UTC 2025)
...
set_log_file fv/dedee/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/dedee -revised fv_map
...
read_library -liberty -both /home/install/FOUNDRY/digital/90nm/dig/lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  hamming_encoder.v hamming_decoder.v dedee.v
elaborate_design -golden -root {dedee} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/dedee/fv_map.v.gz
elaborate_design -revised -root {dedee}
...
#add_name_alias fv/dedee/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/dedee/rtl_to_fv_map.log
}
